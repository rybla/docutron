...
4. **Changelog**. Run the command `cargo --bin create_changelog_entry` to initiate the CLI client for creating a new changelog entry. Follow the CLI instructions to enter the information for the new entry.
